...
@Slf4j
public class Agent {
    //$ java -javaagent:target/javaagent-demo-1.0-SNAPSHOT-jar-with-dependencies.jar -jar target_jar
    ...
    //$ java -jar target/javaagent-demo-1.0-SNAPSHOT-jar-with-dependencies.jar ${targetPID} /${pathtojavaagent-demo}/javaagent-demo/target/javaagent-demo-1.0-SNAPSHOT-jar-with-dependencies.jar
